...
import type { MyLibraryScreenProps, Book } from '../types';

const MyLibraryScreen: React.FC<MyLibraryScreenProps> = ({ navigation }) => {
  const { 
    downloadedBooks, 
    loadDownloadedBooks,
  ...
  const handleBookDoubleTap = (book: Book): void => {
    Alert.alert(
      "Open Book",
