...
export const fetchBookDetails = async (bookId: string): Promise<Book | null> => {
  try {
...
export const getSampleBooks = (): Book[] => [
  {
    id: '1',
    ...
    price: '12.99',
    cover: 'https://via.placeholder.com/80x120/4F46E5/FFFFFF?text=Gatsby',
  ...
  },
  {
    ...
    price: '14.99',
    cover: 'https://via.placeholder.com/80x120/EF4444/FFFFFF?text=Mockingbird',
  ...
  },
  {
    ...
    price: '13.99',
    cover: 'https://via.placeholder.com/80x120/10B981/FFFFFF?text=1984',
  ...
  },
  {
    ...
    price: '11.99',
    cover: 'https://via.placeholder.com/80x120/F59E0B/FFFFFF?text=Pride',
